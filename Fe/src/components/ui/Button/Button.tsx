...
const variants = {
  ...
  ghost: 'text-brand hover:bg-[#fef3e2] hover:text-brand-dark border border-transparent focus:ring-brand/35',
  danger: 'bg-danger text-white hover:bg-[#b42318] border border-transparent focus:ring-danger/35',
  'solid-blue': 'bg-blue-600 text-white hover:bg-blue-700 border border-transparent shadow-sm focus:ring-blue-500/35',
  'solid-green': 'bg-emerald-500 text-white hover:bg-emerald-600 border border-transparent shadow-sm focus:ring-emerald-500/35',
  'solid-red': 'bg-rose-500 text-white hover:bg-rose-600 border border-transparent shadow-sm focus:ring-rose-500/35',
  'outline-blue': 'border border-blue-400 bg-white text-blue-700 hover:bg-blue-50 focus:ring-blue-400/35',
  'outline-green': 'border border-emerald-400 bg-white text-emerald-700 hover:bg-emerald-50 focus:ring-emerald-400/35',
  'outline-red': 'border border-rose-400 bg-white text-rose-700 hover:bg-rose-50 focus:ring-rose-400/35',
  'outline-amber': 'border border-amber-400 bg-white text-amber-700 hover:bg-amber-50 focus:ring-amber-400/35',
  'outline-indigo': 'border border-indigo-300 bg-white text-indigo-700 hover:bg-indigo-50 focus:ring-indigo-400/35',
