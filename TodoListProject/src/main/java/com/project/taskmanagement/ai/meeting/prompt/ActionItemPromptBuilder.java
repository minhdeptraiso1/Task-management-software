...
@Component public class ActionItemPromptBuilder { public String build(ActionItemSuggestionRequest r,String context){return """
...
""".formatted(r.getMeetingType(),blank(r.getMeetingTitle()),blank(r.getAdditionalNote()),r.getMeetingContent(),context); } private String blank(String v){return v==null||v.isBlank()?"Chưa có thông tin":v.trim();} }
