...
public interface BugAttachmentService {
    BugAttachmentResponse upload(UUID projectId, UUID bugId, MultipartFile file) throws IOException;
    ...
    org.springframework.core.io.Resource loadFileAsResource(UUID projectId, UUID bugId, UUID attachmentId);
